...
## Starting Point
Continue from your Lab 04 backend under `student/starter/backend`.
...
## Recovery
Compare with `instructor/solutions/backend/`; if schema state is broken, stop the API and remove only your `TaskApi/tasks.db`.
